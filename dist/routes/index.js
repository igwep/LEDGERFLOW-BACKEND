...
const paymentRoutesSimple_1 = __importDefault(require("./paymentRoutesSimple"));
console.log('👤 UserRoutes imported:', userRoutes_1.default);
...
console.log('👤 User routes object:', userRoutes_1.default);
router.use('/users', userRoutes_1.default);
console.log('💳 Mounting payment routes...');
console.log('💳 Payment routes object:', paymentRoutes_1.default);
router.use('/payments', paymentRoutes_1.default);
console.log('💳 Mounting simple payment routes...');
console.log('💳 Simple payment routes object:', paymentRoutesSimple_1.default);
router.use('/payments', paymentRoutesSimple_1.default);
